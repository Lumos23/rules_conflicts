...
api_dict = {
    "api_base": "https://pliopenaieu2.openai.azure.com/",
    "api_key": "301b0daf4a9d4db79f2dd7fdedd62c72",
...
def run_judge_single(question, answer, judge, ref_answer, multi_turn=False):
    ...
    if model in OPENAI_MODEL_LIST:
        ...
        judgment = chat_completion_openai_azure_new(model, conv, temperature=0, max_tokens=2048, api_dict=api_dict) # for openai >1.0 version
...
def chat_completion_openai(model, conv, temperature, max_tokens, api_dict=None): # support openai=0.28.0
...
def chat_completion_openai_azure_new(model, conv, temperature, max_tokens, api_dict=None): # support for openai >1.0 version
